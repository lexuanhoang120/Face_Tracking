...
class CentroidTracker():
    def __init__(self, threshold_distance=100, max_disappeared=15, frame_tracked=3, confidence=0.99, ):
    ...
    def register(self, centroid):
        ...
        self.flag[self.nextObjectID] = True
        self.nextObjectID += 1
    ...
    def update(self, rects, scores):
        # check to see if the list of input bounding box rectangles
        # is empty
        id_bounding_boxes_face_tracked = []
        if rects.size == 0:
            ...
            # to update
            return self.objects, id_bounding_boxes_face_tracked
            ...
            if inThreshold.size == 0:
                ...
                for (row, col) in zip(rows, cols):
                    ...
                    if row in inThreshold:
                        ...
                        if (self.appeared[objectID] > self.frame_tracked and self.flag[objectID]) or (
                                scores[col] > self.confidence and self.flag[objectID]):
                            id_bounding_boxes_face_tracked.append(col)
